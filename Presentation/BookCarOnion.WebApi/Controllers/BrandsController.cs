...
using BookCarOnion.Application.Features.CQRS.Commands.BrandCommands;
...
namespace BookCarOnion.WebApi.Controllers
{
    ...
    public class BrandsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateBrand(CreateBrandCommand command)
        {
            ...
            return Ok("Brand Information has been added!");
        }
        ...
        public async Task<IActionResult> RemoveBrand(int id)
        {
            ...
            return Ok("Brand Information has been deleted!");
        }
